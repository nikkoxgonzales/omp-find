...
describe('extension + tools wiring (needs core)', () => {
  it('default extension registers commands and tools on a fake pi', async (t) => {
    ...
    assert.deepEqual([...pi.tools.keys()].sort(), ['capsule', 'ffcallers', 'ffcapsule', 'fffind', 'ffgrep', 'ffjfind', 'ffmap', 'ffoutline', 'ffstructural', 'find', 'grep', 'jfind', 'map', 'outline', 'structural'], `override default wires all fifteen: ${[...pi.tools.keys()]}`);
  ...
  it('additive registers ff tools without host names', async (t) => {
    ...
    assert.deepEqual([...pi.tools.keys()].sort(), ['capsule', 'ffcallers', 'ffcapsule', 'fffind', 'ffgrep', 'ffjfind', 'ffmap', 'ffoutline', 'ffstructural', 'jfind', 'map', 'outline', 'structural'], 'additive leaves host names alone');
  });
